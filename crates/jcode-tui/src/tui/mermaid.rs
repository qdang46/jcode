pub use jcode_tui_mermaid::{
    ...
    inline_image_id, inline_image_placeholder_lines, invalidate_render_state, is_mermaid_lang,
    is_video_export_mode, materialize_inline_image, normalize_aspect_ratio,
